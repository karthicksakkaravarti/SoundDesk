...
class VMDS(models.Model):
    ...
    VMDPort = models.IntegerField(null=True, blank=True)
    VMDResolutionHeight =models.IntegerField()
    VMDResolutionwidth = models.IntegerField()
    VMDStatus = models.CharField(max_length=200, null=True, blank=True)
...
class Playlist(models.Model):
    ...
    XCoOrdinates = models.IntegerField(null=True, blank=True)
    YCoOrdinates = models.IntegerField(null=True, blank=True)
    Width = models.IntegerField(null=True, blank=True)
    Height = models.IntegerField(null=True, blank=True)
    BorderLine = models.CharField(max_length=200, null=True, blank=True)
    BackGroundColor = models.CharField(max_length=200, null=True, blank=True)
    type = models.CharField(max_length=200)
    singleLineMessage = models.TextField(null=True, blank=True)
    multilineMessage = models.TextField(null=True, blank=True)
    combineMessae = models.TextField(null=True, blank=True)
