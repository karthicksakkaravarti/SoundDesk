...
export const MessagingMixins = {
    ...
    'get_RegionDimensionAndCoOrdinates', 'post_RegionDimensionAndCoOrdinates', 'post_callColorLightApi','patch_RegionDimensionAndCoOrdinates', 
...
'get_Reports', 'post_Reports', 'patch_Reports', 'delete_Reports']),
