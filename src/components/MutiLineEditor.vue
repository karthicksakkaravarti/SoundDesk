<template>
  <div v-if="editor" ref="editor" style="100%" class="vue-editor">
    <editor-menu-bar
      ...
      <div class="menubar">
        ...
        <div ref="videoPicker" class="relative inline-block button-container">
          ...
          <div v-if="videoPickerVisible" class="">
            ...
            >
              <label for="vue-editor-video-input">Video address:</label>
              <input
                ref="videoInput"
                class="video-input"
              ...
              />
              <button class="video-confirm-button" type="submit">save</button>
            </form>
          </div>
        </div>
        <button
        ...
        <button
          v-tooltip.bottom="'Secondary heading'"
        ...
        <button
          v-tooltip.bottom="'Three-level heading'"
          aria-label="Three-level heading"
          type="button"
          class="menubar__button menubar__title"
        ...
        <div
          ...
          style="width: 44px"
        >
          <a-select class="mb-3 pb-2" size="small" default-value="lucy" v-model="family" style="width: 120px" @change="commands.font_family({font_family: family})" >
